...
# CLANG Configuration
if (FUZZER_ENABLE_CLANG)

    # find external Clang library
    if (FUZZER_USE_EXTERNAL_CLANG)
        set(CLANG_PATH ${KERNEL_FUZZER_LLVM_PROJECT_ROOT}/build/lib/cmake/clang CACHE STRING "path to clang lib")
    ...
    if (FUZZER_ENABLE_GTEST)
        function(add_clang_test target)
            add_gtest(${target} ${ARGN})
            use_clang_library(${target})
        endfunction()
    endif ()
endif ()
